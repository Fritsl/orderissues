...
export const NoteActions: React.FC<NoteActionsProps> = ({
  ...
  <div className="flex items-center justify-between gap-4">
    ...
    <div className="flex items-center gap-1">
      <button
        onClick={onEdit}
        className="p-1 rounded hover:bg-gray-700 touch-manipulation transition-colors group" 
        title="Edit note"
      >
      ...
      <button
        ...
        className={`p-1 rounded hover:bg-gray-700 touch-manipulation transition-colors ${
    ...
    <button
      onClick={onDelete}
      className="p-1 rounded hover:bg-red-900/50 touch-manipulation transition-colors group" 
      title="Delete note"
    >
